...
// class names have been changed to the agree with common .net code conventions
...
namespace mapnik.vector
{
    ...
    public partial class VectorTile : global::ProtoBuf.IExtensible
    {
        public VectorTile() { }

        private readonly global::System.Collections.Generic.List<mapnik.vector.VectorTile.Layer> _layers = new global::System.Collections.Generic.List<mapnik.vector.VectorTile.Layer>();
        [global::ProtoBuf.ProtoMember(3, Name = @"layers", DataFormat = global::ProtoBuf.DataFormat.Default)]
        public global::System.Collections.Generic.List<mapnik.vector.VectorTile.Layer> layers
        {
            get { return _layers; }
        }
        ...
        public partial class Feature : global::ProtoBuf.IExtensible
        {
           public Feature() { }
            ...
            [global::ProtoBuf.ProtoMember(1, IsRequired = false, Name = @"id",
            ...
            private mapnik.vector.VectorTile.GeomType _type = mapnik.vector.VectorTile.GeomType.Unknown;
            [global::ProtoBuf.ProtoMember(3, IsRequired = false, Name = @"type", DataFormat = global::ProtoBuf.DataFormat.TwosComplement)]
            [global::System.ComponentModel.DefaultValue(mapnik.vector.VectorTile.GeomType.Unknown)]
            public mapnik.vector.VectorTile.GeomType type
            {
                get { return _type; }
                set { _type = value; }
            }
        ...
        public partial class Layer : global::ProtoBuf.IExtensible
        {
            ...
            private readonly global::System.Collections.Generic.List<mapnik.vector.VectorTile.Feature> _features = new global::System.Collections.Generic.List<mapnik.vector.VectorTile.Feature>();
            [global::ProtoBuf.ProtoMember(2, Name = @"features", DataFormat = global::ProtoBuf.DataFormat.Default)]
            public global::System.Collections.Generic.List<mapnik.vector.VectorTile.Feature> features
            {
            ...
            private readonly global::System.Collections.Generic.List<mapnik.vector.VectorTile.Value> _values = new global::System.Collections.Generic.List<mapnik.vector.VectorTile.Value>();
            [global::ProtoBuf.ProtoMember(4, Name = @"values", DataFormat = global::ProtoBuf.DataFormat.Default)]
            public global::System.Collections.Generic.List<mapnik.vector.VectorTile.Value> values
            {
                get { return _values; }
            }
